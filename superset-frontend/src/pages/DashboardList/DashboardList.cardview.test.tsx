...
test('DashboardList Card View Tests renders cards instead of table', async () => {
...
test('DashboardList Card View Tests switches from card view to list view', async () => {
  renderDashboardList(mockUser);
  await screen.findByTestId('dashboard-list-view');
...
test('DashboardList Card View Tests displays dashboard data correctly in cards', async () => {
  renderDashboardList(mockUser);
...
test('DashboardList Card View Tests renders sort dropdown in card view', async () => {
  renderDashboardList(mockUser);
  await screen.findByTestId('dashboard-list-view');
...
test('DashboardList Card View Tests selecting a sort option triggers new API call', async () => {
  renderDashboardList(mockUser);
  await screen.findByTestId('dashboard-list-view');
...
test('DashboardList Card View Tests can bulk deselect all dashboards', async () => {
  renderDashboardList(mockUser);
...
test('DashboardList Card View Tests can bulk export selected dashboards', async () => {
  renderDashboardList(mockUser);
...
test('DashboardList Card View Tests can bulk delete selected dashboards', async () => {
  renderDashboardList(mockUser);
...
test('DashboardList Card View Tests exit bulk select by hitting x on bulk select bar', async () => {
  renderDashboardList(mockUser);
...
test('DashboardList Card View Tests card click behavior changes in bulk select mode', async () => {
  renderDashboardList(mockUser);
