...
test('ChartList Card View Tests renders ChartList in card view', async () => {
...
test('ChartList Card View Tests switches from card view to list view', async () => {
  renderChartList(mockUser);
  await screen.findByTestId('chart-list-view');
...
test('ChartList Card View Tests renders ChartList in card view with thumbnails enabled', async () => {
...
test('ChartList Card View Tests displays chart data correctly', async () => {
  renderChartList(mockUser);
...
test('ChartList Card View Tests export chart api called when export button is clicked', async () => {
  renderChartList(mockUser);
...
test('ChartList Card View Tests opens edit properties modal when edit button is clicked', async () => {
  renderChartList(mockUser);
...
test('ChartList Card View Tests opens delete confirmation when delete button is clicked', async () => {
  renderChartList(mockUser);
...
test('ChartList Card View Tests displays certified badge only for certified charts', async () => {
  renderChartList(mockUser);
...
test('ChartList Card View Tests can bulk deselect all charts', async () => {
  renderChartList(mockUser);
...
test('ChartList Card View Tests can bulk export selected charts', async () => {
  renderChartList(mockUser);
...
test('ChartList Card View Tests can bulk delete selected charts', async () => {
  renderChartList(mockUser);
...
test('ChartList Card View Tests can bulk add tags to selected charts', async () => {
...
test('ChartList Card View Tests exit bulk select by hitting x on bulk select bar', async () => {
  renderChartList(mockUser);
...
test('ChartList Card View Tests card click behavior changes in bulk select mode', async () => {
  renderChartList(mockUser);
...
test('ChartList Card View Tests renders sort dropdown in card view', async () => {
  renderChartList(mockUser);
  await screen.findByTestId('chart-list-view');
