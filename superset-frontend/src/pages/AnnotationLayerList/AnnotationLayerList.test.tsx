...
test('AnnotationLayersList renders', async () => {
  renderAnnotationLayersList();
  expect(await screen.findByText('Annotation layers')).toBeInTheDocument();
});

test('AnnotationLayersList renders a SubMenu', async () => {
  renderAnnotationLayersList();
  expect(await screen.findByRole('navigation')).toBeInTheDocument();
});

test('AnnotationLayersList renders a ListView', async () => {
  renderAnnotationLayersList();
  expect(
...
test('AnnotationLayersList renders a modal', async () => {
  renderAnnotationLayersList();
...
test('AnnotationLayersList fetches layers', async () => {
  renderAnnotationLayersList();
  await waitFor(() => {
...
test('AnnotationLayersList renders Filters', async () => {
  renderAnnotationLayersList();
  await screen.findByTestId('annotation-layers-list-view');
  expect(screen.getByPlaceholderText(/type a value/i)).toBeInTheDocument();
});

test('AnnotationLayersList searches', async () => {
  renderAnnotationLayersList();
...
test('AnnotationLayersList deletes', async () => {
  renderAnnotationLayersList();
...
test('AnnotationLayersList shows bulk actions when bulk select is clicked', async () => {
  renderAnnotationLayersList();
