...
test('Filter utils getRangeExtraFormData getRangeExtraFormData - col: "testCol", lower: 1, upper: 2', () => {
...
test('Filter utils getRangeExtraFormData getRangeExtraFormData - col: "testCol", lower: 0, upper: 0', () => {
...
test('Filter utils getRangeExtraFormData getRangeExtraFormData - col: "testCol", lower: null, upper: 2', () => {
...
test('Filter utils getRangeExtraFormData getRangeExtraFormData - col: "testCol", lower: 1, upper: undefined', () => {
...
test('Filter utils getSelectExtraFormData getSelectExtraFormData - col: "testCol", value: ["value"], emptyFilter: false, inverseSelection: false', () => {
...
test('Filter utils getSelectExtraFormData getSelectExtraFormData - col: "testCol", value: ["value"], emptyFilter: true, inverseSelection: false', () => {
...
test('Filter utils getSelectExtraFormData getSelectExtraFormData - col: "testCol", value: ["value"], emptyFilter: false, inverseSelection: true', () => {
...
test('Filter utils getSelectExtraFormData getSelectExtraFormData - col: "testCol", value: [], emptyFilter: false, inverseSelection: false', () => {
  expect(getSelectExtraFormData('testCol', [], false, false)).toEqual({});
});

test('Filter utils getSelectExtraFormData getSelectExtraFormData - col: "testCol", value: undefined, emptyFilter: false, inverseSelection: false', () => {
  expect(getSelectExtraFormData('testCol', undefined, false, false)).toEqual(
    {},
  );
});

test('Filter utils getSelectExtraFormData getSelectExtraFormData - col: "testCol", value: null, emptyFilter: false, inverseSelection: false', () => {
  expect(getSelectExtraFormData('testCol', null, false, false)).toEqual({});
});

test('Filter utils getDataRecordFormatter default formatter returns expected values', () => {
...
test('Filter utils getDataRecordFormatter formatter with defined formatters returns expected values', () => {
  const formatter = getDataRecordFormatter({
  ...
  expect(formatter('1970-01-01 00:00:00', GenericDataType.Temporal)).toEqual(
    '1970-01-01 00:00:00',
  );
});
