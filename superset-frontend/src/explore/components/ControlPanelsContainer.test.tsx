...
test('ControlPanelsContainer renders ControlPanelSections', async () => {
...
test('ControlPanelsContainer renders ControlPanelSections no Customize Tab', async () => {
  getChartControlPanelRegistry().remove('table');
...
test('ControlPanelsContainer visibility of panels is correctly applied', async () => {
  getChartControlPanelRegistry().remove('table');
  getChartControlPanelRegistry().registerValue('table', {
    controlPanelSections: [
      {
  ...
  expect(getByTestId('mock-formdata')).not.toHaveTextContent('percent_metrics');
});

test('ControlPanelsContainer hidden state of controls is correctly applied', async () => {
  getChartControlPanelRegistry().remove('table');
  getChartControlPanelRegistry().registerValue('table', {
    controlPanelSections: [
      {
...
test('ControlPanelsContainer should stay on Matrixify tab when matrixify is enabled', async () => {
...
test('ControlPanelsContainer should automatically switch to Matrixify tab when matrixify becomes enabled', async () => {
  // Enable Matrixify feature flag
  mockIsFeatureEnabled.mockImplementation(
    (featureFlag: FeatureFlag) => featureFlag === FeatureFlag.Matrixify,
  );
...
test('ControlPanelsContainer should stash control value when visibility is false and disableStash is not set', async () => {
  getChartControlPanelRegistry().remove('table');
  getChartControlPanelRegistry().registerValue('table', {
    controlPanelSections: [
      {
...
test('ControlPanelsContainer should preserve control value when visibility is false and disableStash is true', async () => {
  getChartControlPanelRegistry().remove('table');
  getChartControlPanelRegistry().registerValue('table', {
    controlPanelSections: [
      {
...
test('ControlPanelsContainer should not show Matrixify tab for table chart types', async () => {
  // Enable Matrixify feature flag
  mockIsFeatureEnabled.mockImplementation(
    (featureFlag: FeatureFlag) => featureFlag === FeatureFlag.Matrixify,
  );
...
test('ControlPanelsContainer should show Matrixify tab for supported chart types', async () => {
  // Enable Matrixify feature flag
  mockIsFeatureEnabled.mockImplementation(
    (featureFlag: FeatureFlag) => featureFlag === FeatureFlag.Matrixify,
  );
