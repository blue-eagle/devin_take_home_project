...
test('ColorBreakpointPopoverControl should render with default props', () => {
  renderComponent();
...
test('ColorBreakpointPopoverControl should render close and save buttons', () => {
  renderComponent();
...
test('ColorBreakpointPopoverControl should render with existing breakpoint values', () => {
  renderComponent();
...
test('ColorBreakpointPopoverControl should call onClose when close button is clicked', async () => {
...
test('ColorBreakpointPopoverControl should disable save button when form is incomplete', () => {
...
test('ColorBreakpointPopoverControl should enable save button when form is complete', async () => {
...
test('ColorBreakpointPopoverControl should call onSave with correct values when save button is clicked', async () => {
...
test('ColorBreakpointPopoverControl should disable save button when min value >= max value', async () => {
  renderComponent({ value: undefined });
...
test('ColorBreakpointPopoverControl should disable save button when breakpoint overlaps with existing ones', async () => {
...
test('ColorBreakpointPopoverControl should handle non-numeric input validation', async () => {
  renderComponent({ value: undefined });
...
test('ColorBreakpointPopoverControl should update min value when input changes', async () => {
  renderComponent();
...
test('ColorBreakpointPopoverControl should update max value when input changes', async () => {
  renderComponent();
...
test('ColorBreakpointPopoverControl should handle zero values correctly', async () => {
  renderComponent({
    value: mockEmptyBreakpoint,
  });
...
test('ColorBreakpointPopoverControl should handle negative values correctly', async () => {
  renderComponent({
    value: mockEmptyBreakpoint,
  });
...
test('ColorBreakpointPopoverControl should handle decimal values correctly', async () => {
  renderComponent({
    value: mockEmptyBreakpoint,
  });
...
test('ColorBreakpointPopoverControl should not show overlap error when editing existing breakpoint', async () => {
  const existingBreakpoints: ColorBreakpointType[] = [
    {
      id: 0,
      color: { r: 255, g: 0, b: 0, a: 100 },
