...
test('Custom TimeRange customTimeRangeEncode 1) specific : specific', () => {
  expect(
...
test('Custom TimeRange customTimeRangeEncode 2) specific : relative', () => {
  expect(
    customTimeRangeEncode({
      sinceDatetime: '2021-01-20T00:00:00',
      sinceMode: 'specific',
...
test('Custom TimeRange customTimeRangeEncode 3) now : relative', () => {
  expect(
    customTimeRangeEncode({
      sinceDatetime: 'now',
      sinceMode: 'now',
...
test('Custom TimeRange customTimeRangeEncode 4) today : relative', () => {
  expect(
    customTimeRangeEncode({
      sinceDatetime: 'today',
      sinceMode: 'today',
...
test('Custom TimeRange customTimeRangeEncode 5) relative : specific', () => {
  expect(
    customTimeRangeEncode({
...
test('Custom TimeRange customTimeRangeEncode 6) relative : now', () => {
  expect(
    customTimeRangeEncode({
      sinceDatetime: 'now',
      sinceMode: 'relative',
...
test('Custom TimeRange customTimeRangeEncode 7) relative : today', () => {
  expect(
    customTimeRangeEncode({
      sinceDatetime: 'today',
      sinceMode: 'relative',
...
test('Custom TimeRange customTimeRangeEncode 8) relative : relative (now)', () => {
  expect(
    customTimeRangeEncode({
      sinceDatetime: 'now',
      sinceMode: 'relative',
...
test('Custom TimeRange customTimeRangeEncode 9) relative : relative (date/time)', () => {
  expect(
    customTimeRangeEncode({
      sinceDatetime: '2021-01-27T00:00:00',
      sinceMode: 'relative',
