...
test('Option renders with default props', async () => {
  ...
  expect(screen.queryByRole('img', { name: 'right' })).not.toBeInTheDocument();
  unmount();
});

test('Option renders with caret', async () => {
...
test('Option renders with extra triangle', async () => {
  const { unmount } = render(
...
test('Option triggers onClose', async () => {
