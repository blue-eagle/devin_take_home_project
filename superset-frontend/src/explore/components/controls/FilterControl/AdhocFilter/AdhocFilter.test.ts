...
test('AdhocFilter sets filterOptionName in constructor', () => {
...
test('AdhocFilter can create altered duplicates', () => {
...
test('AdhocFilter can verify equality', () => {
  const adhocFilter1 = new AdhocFilter({
    expressionType: ExpressionTypes.Simple,
    subject: 'value',
    operator: '>',
...
test('AdhocFilter can verify inequality', () => {
  const adhocFilter1 = new AdhocFilter({
    expressionType: ExpressionTypes.Simple,
    subject: 'value',
    operator: '>',
...
test('AdhocFilter can determine if it is valid', () => {
  const adhocFilter1 = new AdhocFilter({
    expressionType: ExpressionTypes.Simple,
    subject: 'value',
    operator: '>',
...
test('AdhocFilter can translate from simple expressions to sql expressions', () => {
  const adhocFilter1 = new AdhocFilter({
    expressionType: ExpressionTypes.Simple,
    subject: 'value',
    operator: '==',
...
test('AdhocFilter sets comparator to undefined when operator is IS_NULL', () => {
  const adhocFilter = new AdhocFilter({
    expressionType: ExpressionTypes.Simple,
    subject: 'SUM(value)',
    operator: 'IS NULL',
...
test('AdhocFilter sets comparator to undefined when operator is IS_NOT_NULL', () => {
  const adhocFilter = new AdhocFilter({
    expressionType: ExpressionTypes.Simple,
    subject: 'SUM(value)',
    operator: 'IS NOT NULL',
...
test('AdhocFilter sets comparator to undefined when operator is IS_TRUE', () => {
  const adhocFilter = new AdhocFilter({
    expressionType: ExpressionTypes.Simple,
    subject: 'col',
    operator: 'IS TRUE',
...
test('AdhocFilter sets comparator to undefined when operator is IS_FALSE', () => {
  const adhocFilter = new AdhocFilter({
    expressionType: ExpressionTypes.Simple,
    subject: 'col',
    operator: 'IS FALSE',
...
test('AdhocFilter sets the label properly if subject is a string', () => {
  const adhocFilter = new AdhocFilter({
    expressionType: ExpressionTypes.Simple,
    subject: 'order_date',
  });
...
test('AdhocFilter sets the label properly if subject is an object with the column_date property', () => {
  const adhocFilter = new AdhocFilter({
    expressionType: ExpressionTypes.Simple,
    subject: {
      column_name: 'year',
...
test('AdhocFilter sets the label to empty is there is no column_name in the object', () => {
  const adhocFilter = new AdhocFilter({
    expressionType: ExpressionTypes.Simple,
    subject: {
      unknown: 'year',
...
test('AdhocFilter sets the label to empty is there is no subject', () => {
  const adhocFilter = new AdhocFilter({
    expressionType: ExpressionTypes.Simple,
    subject: undefined,
  });
