...
test('cachedSupersetGet clearDatasetCache clears cache entries for specific dataset ID', () => {
...
test('cachedSupersetGet clearDatasetCache clears cache entries for string dataset ID', () => {
...
test('cachedSupersetGet clearDatasetCache handles null dataset ID gracefully', () => {
  supersetGetCache.set('/api/v1/dataset/123', { data: 'dataset123' });
...
test('cachedSupersetGet clearDatasetCache handles undefined dataset ID gracefully', () => {
  supersetGetCache.set('/api/v1/dataset/123', { data: 'dataset123' });
...
test('cachedSupersetGet clearDatasetCache handles empty string dataset ID gracefully', () => {
  supersetGetCache.set('/api/v1/dataset/123', { data: 'dataset123' });
...
test('cachedSupersetGet clearDatasetCache does not clear unrelated cache entries', () => {
...
test('cachedSupersetGet clearDatasetCache only clears exact dataset ID matches', () => {
...
test('cachedSupersetGet clearDatasetCache clears cache entries with various URL patterns', () => {
...
test('cachedSupersetGet clearAllDatasetCache clears all dataset cache entries', () => {
  supersetGetCache.set('/api/v1/dataset/123', { data: 'dataset123' });
  supersetGetCache.set('/api/v1/dataset/456', { data: 'dataset456' });
  supersetGetCache.set('/api/v1/dataset/789/columns', { data: 'columns' });
  supersetGetCache.set('/api/v1/chart/123', { data: 'chart123' });
...
test('cachedSupersetGet clearAllDatasetCache handles empty cache gracefully', () => {
...
test('cachedSupersetGet clearAllDatasetCache preserves non-dataset cache entries', () => {
...
test('cachedSupersetGet clearAllDatasetCache clears all variations of dataset endpoints', () => {
