...
function ChartRenderer({
  ...
  // Clone queriesResponse to avoid state mutation by plugins
  ...
  const handleLegendScroll = useCallback((idx: number) => {
    setLegendIndex(idx);
  }, []);
    ...
    <>
      ...
      >
        <SuperChart
          ...
          isRefreshing={
            Boolean(suppressLoadingSpinner) &&
            chartStatus === 'loading'
          }
          {...drillToDetailProps}
        />
