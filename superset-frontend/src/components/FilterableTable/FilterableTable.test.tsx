...
test('FilterableTable is valid element', () => {
  expect(isValidElement(<FilterableTable {...mockedProps} />)).toBe(true);
});

test('FilterableTable renders a grid with 3 Table rows', () => {
  const { getByRole, getByText } = render(<FilterableTable {...mockedProps} />);
...
test('FilterableTable filters on a string', () => {
  const props = {
    ...mockedProps,
    filterText: 'b1',
  };
...
test('FilterableTable filters on a number', () => {
  const props = {
    ...mockedProps,
    filterText: '100',
  };
...
test('FilterableTable shows all rows when filterText is empty', () => {
  const props = {
    ...mockedProps,
    filterText: '',
  };
...
test('FilterableTable updates filtered rows when filterText prop changes', () => {
  const props = {
    ...mockedProps,
    filterText: 'b1',
  };
...
test('FilterableTable shows all rows when filterText is cleared', () => {
  const props = {
    ...mockedProps,
    filterText: 'b1',
  };
...
test('FilterableTable sorting - RTL sorts strings correctly', () => {
  const stringProps = {
...
test('FilterableTable sorting - RTL sorts integers correctly', () => {
  const integerProps = {
...
test('FilterableTable sorting - RTL sorts floating numbers correctly', () => {
  const floatProps = {
...
test('FilterableTable sorting - RTL sorts rows properly when floating numbers have mixed types', () => {
...
test('FilterableTable sorting - RTL sorts YYYY-MM-DD properly', () => {
  const dsProps = {
