...
test('updateColumns adds new columns when prevCols is empty', () => {
  interface Column {
    column_name: string;
    type: string;
    is_dttm: boolean;
...
test('updateColumns modifies columns when type or is_dttm changes', () => {
  const prevCols = [
    { column_name: 'col1', type: 'string', is_dttm: false },
...
test('updateColumns removes columns not present in newCols', () => {
  const prevCols = [
    { column_name: 'col1', type: 'string', is_dttm: false },
    { column_name: 'col2', type: 'number', is_dttm: true },
  ];
...
test('updateColumns handles combined additions, modifications, and removals', () => {
  const prevCols = [
    { column_name: 'col1', type: 'string', is_dttm: false },
    { column_name: 'col2', type: 'number', is_dttm: false },
...
test('updateColumns should not remove columns with expressions', () => {
  const prevCols = [
    { column_name: 'col1', type: 'string', is_dttm: false },
    { column_name: 'col2', type: 'number', is_dttm: false },
    {
