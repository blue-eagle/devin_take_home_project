...
test('FacePile renders empty state with no users', () => {
...
test('FacePile renders single user without truncation', () => {
...
test('FacePile renders multiple users no truncation', () => {
...
test('FacePile renders multiple users with truncation', () => {
...
test('FacePile displays user tooltip on hover', () => {
...
test('FacePile displays avatar images when Slack avatars are enabled', () => {
...
test('utils getRandomColor produces the same color for the same input values', () => {
  const name = 'foo';
  expect(getRandomColor(name, colors)).toEqual(getRandomColor(name, colors));
});

test('utils getRandomColor produces a different color for different input values', () => {
  expect(getRandomColor('foo', colors)).not.toEqual(
    getRandomColor('bar', colors),
  );
});

test('utils getRandomColor handles non-ascii input values', () => {
