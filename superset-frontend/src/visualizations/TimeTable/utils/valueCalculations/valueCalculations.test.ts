...
test('valueCalculations calculateTimeValue should calculate diff comparison correctly', () => {
...
test('valueCalculations calculateTimeValue should skip null values when finding lagged data points', () => {
...
test('valueCalculations calculateTimeValue should maintain consistency between filtered and unfiltered behavior', () => {
...
test('valueCalculations calculateTimeValue should calculate perc comparison correctly', () => {
  const column: ColumnConfig = {
    key: 'test',
    colType: 'time',
    comparisonType: 'perc',
...
test('valueCalculations calculateTimeValue should calculate perc_change comparison correctly', () => {
  const column: ColumnConfig = {
    key: 'test',
    colType: 'time',
...
test('valueCalculations calculateTimeValue should handle negative time lag', () => {
  const column: ColumnConfig = {
    key: 'test',
    colType: 'time',
    comparisonType: 'diff',
...
test('valueCalculations calculateTimeValue should return error for excessive time lag', () => {
  const column: ColumnConfig = {
    key: 'test',
    colType: 'time',
    timeLag: 10,
...
test('valueCalculations calculateTimeValue should return null for invalid values', () => {
  const column: ColumnConfig = {
    key: 'test',
    colType: 'time',
    timeLag: 1,
...
test('valueCalculations calculateTimeValue should return lagged value when no comparison type', () => {
  const column: ColumnConfig = {
    key: 'test',
    colType: 'time',
    timeLag: 1,
...
test('valueCalculations calculateTimeValue should handle multiple null values with different time lags', () => {
...
test('valueCalculations calculateTimeValue should work with perc and perc_change when nulls are present', () => {
  const entriesWithNulls: Entry[] = [
...
test('valueCalculations calculateTimeValue should return null when not enough non-null values for time lag', () => {
...
test('valueCalculations calculateContribution should calculate contribution correctly', () => {
...
test('valueCalculations calculateContribution should return null for null recent value', () => {
  const result = calculateContribution(null, mockEntries);
  expect(result.value).toBeNull();
});

test('valueCalculations calculateContribution should return null for empty entries', () => {
  const result = calculateContribution(300, []);
  expect(result.value).toBeNull();
});

test('valueCalculations calculateContribution should return null when total is zero', () => {
...
test('valueCalculations calculateAverage should calculate average correctly', () => {
  const column: ColumnConfig = {
    key: 'test',
    colType: 'avg',
    timeLag: 2,
...
test('valueCalculations calculateAverage should handle null/undefined values', () => {
  const entriesWithNulls: Entry[] = [
    { time: '2023-01-03', sales: 300 },
    { time: '2023-01-02', sales: null },
    { time: '2023-01-01', sales: 100 },
...
test('valueCalculations calculateAverage should return null for empty entries', () => {
  const column: ColumnConfig = {
    key: 'test',
    colType: 'avg',
  };
...
test('valueCalculations calculateAverage should return null when all values are null', () => {
...
test('valueCalculations calculateCellValue should route to time calculation', () => {
  const column: ColumnConfig = {
    key: 'test',
    colType: 'time',
    comparisonType: 'diff',
...
test('valueCalculations calculateCellValue should route to contribution calculation', () => {
  const column: ColumnConfig = {
    key: 'test',
    colType: 'contrib',
  };
...
test('valueCalculations calculateCellValue should route to average calculation', () => {
  const column: ColumnConfig = {
    key: 'test',
    colType: 'avg',
    timeLag: 2,
...
test('valueCalculations calculateCellValue should return recent value for default case', () => {
  const column: ColumnConfig = {
    key: 'test',
  };
...
test('valueCalculations calculateCellValue should return null for empty entries', () => {
  const column: ColumnConfig = {
    key: 'test',
    colType: 'time',
  };
