...
test('isDashboardLoading returns false when no charts are loading', () => {
...
test('isDashboardLoading returns true when any chart has start > end', () => {
  const charts: Record<string, ChartLoadTimestamps> = {
...
test('isDashboardLoading treats missing end as 0', () => {
  const charts: Record<string, ChartLoadTimestamps> = {
...
test('isDashboardLoading handles empty charts object', () => {
