 ...
 * under the License.
 */
import getDetailedComponentWidthOriginal from 'src/dashboard/util/getDetailedComponentWidth';
...
test('getDetailedComponentWidth should return an object with width, minimumWidth, and occupiedWidth', () => {
  expect(
    Object.keys(getDetailedComponentWidth({ id: '_', components: {} })),
  ).toEqual(expect.arrayContaining(['minimumWidth', 'occupiedWidth', 'width']));
});

test('getDetailedComponentWidth width should be undefined if the component is not resizable and has no defined width', () => {
  const empty = {
    width: undefined,
...
test('getDetailedComponentWidth width should match component meta width for resizable components', () => {
  expect(
    getDetailedComponentWidth({
...
test('getDetailedComponentWidth width should be GRID_COLUMN_COUNT for row components WITHOUT parents', () => {
  expect(
    getDetailedComponentWidth({
      id: 'row',
...
test('getDetailedComponentWidth width should match parent width for row components WITH parents', () => {
  expect(
    getDetailedComponentWidth({
      id: 'row',
      components: {
...
test('getDetailedComponentWidth width should use either id or component (to support new components)', () => {
  expect(
    getDetailedComponentWidth({
      id: 'id',
      components: {
...
test('getDetailedComponentWidth occupiedWidth should reflect the sum of child widths for row components', () => {
  expect(
    getDetailedComponentWidth({
      id: 'row',
      components: {
...
test('getDetailedComponentWidth occupiedWidth should always be zero for column components', () => {
  expect(
    getDetailedComponentWidth({
...
test('getDetailedComponentWidth minimumWidth should equal GRID_MIN_COLUMN_COUNT for resizable components', () => {
  expect(
    getDetailedComponentWidth({
      component: { id: '', type: types.CHART_TYPE, meta: { width: 1 } },
    }),
...
test('getDetailedComponentWidth minimumWidth should equal the width of row children for column components with row children', () => {
  expect(
    getDetailedComponentWidth({
      id: 'column',
      components: {
...
test('getDetailedComponentWidth minimumWidth should equal occupiedWidth for row components', () => {
  expect(
    getDetailedComponentWidth({
      id: 'row',
      components: {
