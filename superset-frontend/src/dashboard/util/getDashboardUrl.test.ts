...
test('getChartIdsFromLayout should encode filters', () => {
...
test('getChartIdsFromLayout should encode filters with hash', () => {
...
test('getChartIdsFromLayout should encode filters with standalone', () => {
...
test('getChartIdsFromLayout should encode filters with missing standalone', () => {
  const urlWithStandalone = getDashboardUrl({
    pathname: 'path',
    filters,
    hash: '',
...
test('getChartIdsFromLayout should encode filters with missing filters', () => {
  const urlWithStandalone = getDashboardUrl({
    pathname: 'path',
    filters: {},
    hash: '',
...
test('getChartIdsFromLayout should preserve unknown filters', () => {
...
test('getChartIdsFromLayout should pass through a router-relative pathname unchanged', () => {
  const url = getDashboardUrl({
...
test('getChartIdsFromLayout should process native filters key', () => {
  jest.spyOn(window, 'location', 'get').mockReturnValue({
    ...window.location,
    origin: 'https://localhost',
    search:
