...
test('childChartsDidLoad returns didLoad true when all charts are in completed states', () => {
...
test('childChartsDidLoad returns didLoad false when some charts are in loading state', () => {
  const chartIds = [1, 2, 3];
  const layout: Layout = {};
  const chartQueries: Record<string, Partial<ChartState>> = {
    '1': { chartStatus: 'rendered', chartUpdateStartTime: 100 },
...
test('childChartsDidLoad handles missing chart queries gracefully', () => {
  const chartIds = [1, 2, 3];
  const layout: Layout = {};
  const chartQueries: Record<string, Partial<ChartState>> = {
    '1': { chartStatus: 'rendered', chartUpdateStartTime: 100 },
...
test('childChartsDidLoad handles empty chart queries object', () => {
  const chartIds = [1, 2, 3];
  const layout: Layout = {};
  const chartQueries: Record<string, Partial<ChartState>> = {};
...
test('childChartsDidLoad handles empty chart IDs array', () => {
...
test('childChartsDidLoad calculates minimum query start time correctly', () => {
...
test('childChartsDidLoad handles charts with missing chartUpdateStartTime', () => {
  const chartIds = [1, 2];
  const layout: Layout = {};
  const chartQueries: Record<string, Partial<ChartState>> = {
...
test('childChartsDidLoad handles charts with null chartStatus', () => {
  const chartIds = [1, 2];
  const layout: Layout = {};
  const chartQueries: Record<string, Partial<ChartState>> = {
...
test('childChartsDidLoad recognizes all valid completed chart states', () => {
  const chartIds = [1, 2, 3];
  const layout: Layout = {};
  const chartQueries: Record<string, Partial<ChartState>> = {
...
test('childChartsDidLoad does not recognize incomplete chart states', () => {
  const chartIds = [1, 2];
  const layout: Layout = {};
  const chartQueries: Record<string, Partial<ChartState>> = {
