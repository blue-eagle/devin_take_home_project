...
test('dashboardLayout reducer should return initial state for unrecognized actions', () => {
  expect(testReducer(undefined, {})).toEqual({});
});

test('dashboardLayout reducer should delete a component, remove its reference in its parent, and recursively all of its children', () => {
  expect(
    testReducer(
      {
        toDelete: {
...
test('dashboardLayout reducer should delete a parent if the parent was a row and no longer has children', () => {
  expect(
    testReducer(
      {
        grandparentId: {
...
test('dashboardLayout reducer should update components', () => {
  expect(
    testReducer(
      {
        update: {
...
test('dashboardLayout reducer should move a component', () => {
  const layout = {
    source: {
      id: 'source',
      type: ROW_TYPE,
...
test('dashboardLayout reducer should wrap a moved component in a row if need be', () => {
  const layout = {
    source: {
      id: 'source',
      type: ROW_TYPE,
...
test('dashboardLayout reducer should add top-level tabs from a new tabs component, moving grid children to new tab', () => {
  const layout = {
    [DASHBOARD_ROOT_ID]: {
...
test('dashboardLayout reducer should add top-level tabs from an existing tabs component, moving grid children to new tab', () => {
  const layout = {
    [DASHBOARD_ROOT_ID]: {
      id: DASHBOARD_ROOT_ID,
      children: [DASHBOARD_GRID_ID],
...
test('dashboardLayout reducer should remove top-level tabs, moving children to the grid', () => {
  const layout = {
    [DASHBOARD_ROOT_ID]: {
      id: DASHBOARD_ROOT_ID,
      children: ['tabs'],
...
test('dashboardLayout reducer should create a component', () => {
  const layout = {
    [DASHBOARD_ROOT_ID]: {
      id: DASHBOARD_ROOT_ID,
      children: [DASHBOARD_GRID_ID],
...
test('dashboardLayout reducer should update parents array when creating top-level tabs', () => {
  const layout = {
    [DASHBOARD_ROOT_ID]: {
      id: DASHBOARD_ROOT_ID,
      type: DASHBOARD_ROOT_TYPE,
...
test('dashboardLayout reducer should update parents array when moving a component', () => {
  const layout = {
    [DASHBOARD_ROOT_ID]: {
      id: DASHBOARD_ROOT_ID,
      type: DASHBOARD_ROOT_TYPE,
...
test('dashboardLayout reducer recursivelyDeleteChildren should be error proof with bad inputs', () => {
  /*
