...
test('sliceEntities reducer should return initial state', () => {
  expect(
...
test('sliceEntities reducer should set loading when fetching slices', () => {
  expect(
    sliceEntitiesReducer(
...
test('sliceEntities reducer should set slices', () => {
...
test('sliceEntities reducer should set an error on error', () => {
  const result = sliceEntitiesReducer(
    {} as ReducerState,
    {
