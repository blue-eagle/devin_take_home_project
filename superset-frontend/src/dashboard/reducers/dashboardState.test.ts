...
test('DashboardState reducer SET_ACTIVE_TAB switches a single tab', () => {
...
test('DashboardState reducer SET_ACTIVE_TAB switches a multi-depth tab', () => {
...
test('DashboardState reducer SET_ACTIVE_TABS', () => {
  expect(
    typedDashboardStateReducer(
      createMockDashboardState({ activeTabs: [] }),
      setActiveTabs(['tab1']),
...
test('DashboardState reducer should return initial state', () => {
  expect(typedDashboardStateReducer(undefined, {} as { type: string })).toEqual(
    {},
  );
});

test('DashboardState reducer should add a slice', () => {
  expect(
...
test('DashboardState reducer should remove a slice', () => {
  expect(
    typedDashboardStateReducer(
...
test('DashboardState reducer should toggle fav star', () => {
  expect(
    typedDashboardStateReducer(
...
test('DashboardState reducer should toggle edit mode', () => {
  expect(
    typedDashboardStateReducer({ editMode: false } as Partial<DashboardState>, {
      type: SET_EDIT_MODE,
      editMode: true,
    }),
  ).toEqual({
...
test('DashboardState reducer should toggle expanded slices', () => {
  expect(
    typedDashboardStateReducer(
...
test('DashboardState reducer should set hasUnsavedChanges', () => {
  expect(
...
test('DashboardState reducer should set maxUndoHistoryExceeded', () => {
  expect(
    typedDashboardStateReducer({} as Partial<DashboardState>, {
...
test('DashboardState reducer should set unsaved changes, max undo history, and editMode to false on save', () => {
...
test('DashboardState reducer should reset lastModifiedTime on save', () => {
...
test('DashboardState reducer should clear the focused filter field', () => {
  const initState = {
    focusedFilterField: {
      chartId: 1,
      column: 'column_1',
...
test('DashboardState reducer should only clear focused filter when the fields match', () => {
  const initState = {
    focusedFilterField: {
      chartId: 1,
      column: 'column_1',
...
test('DashboardState reducer should toggle native filters bar', () => {
  expect(
    typedDashboardStateReducer(
...
test('DashboardState reducer should update chart state', () => {
...
test('DashboardState reducer should remove chart state', () => {
  const initState = {
    chartStates: {
...
test('DashboardState reducer should restore chart states', () => {
  const chartStates = {
    123: { chartId: 123, vizType: 'ag-grid-table', state: {} },
  };
  const result = typedDashboardStateReducer(
...
test('DashboardState reducer should restore chart states to empty when given null', () => {
  const initState = {
    chartStates: {
      123: { chartId: 123, vizType: 'ag-grid-table', state: {} },
    },
...
test('DashboardState reducer should clear all chart states', () => {
  const initState = {
    chartStates: {
      123: { chartId: 123, vizType: 'ag-grid-table', state: {} },
      456: { chartId: 456, vizType: 'ag-grid-table', state: {} },
