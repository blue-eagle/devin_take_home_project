...
const layout = {
  ...
  'CHART-8OG3UJX-Tn': {
    ...
    parents: ['ROOT_ID', 'TABS-97PVJa11D_', 'TAB-lg-5ymUDgm', 'ROW-7kAf1blYU'],
    type: 'CHART',
  },
  'CHART-W02beJK7ms': {
    children: [],
  ...
  'CHART-XRvRfsMsaQ': {
    ...
    parents: ['ROOT_ID', 'TABS-97PVJa11D_', 'TAB-lg-5ymUDgm', 'ROW-NuR8GFQTO'],
    type: 'CHART',
  },
  'CHART-XVIYTeubZh': {
    children: [],
  ...
  'CHART-wt6ZO8jRXZ': {
    ...
    parents: ['ROOT_ID', 'TABS-97PVJa11D_', 'TAB-lg-5ymUDgm', 'ROW-XT1DsNA_V'],
    type: 'CHART',
  },
  'COLUMN-F53B1OSMcz': {
  ...
  'MARKDOWN-JOZKOjVc3a': {
    ...
    parents: ['ROOT_ID', 'TABS-97PVJa11D_', 'TAB-lg-5ymUDgm', 'ROW-0F99WDC-sz'],
    type: 'MARKDOWN',
  },
  ROOT_ID: {
    children: ['TABS-97PVJa11D_'],
...
test('Ensure buildTree does not throw runtime errors when encountering an invalid node Succeeds with valid', () => {
  expect(() => {
    buildTree(
...
test('Ensure buildTree does not throw runtime errors when encountering an invalid node Does not infinitely recurse when layout contains a cycle (nested tabs circular reference)', () => {
...
test('Ensure buildTree does not throw runtime errors when encountering an invalid node getTreeCheckedItems does not infinitely recurse when scope rootPath creates a cycle', () => {
...
test('Ensure buildTree does not throw runtime errors when encountering an invalid node Avoids runtime error with invalid inputs', () => {
  expect(() => {
    buildTree(
