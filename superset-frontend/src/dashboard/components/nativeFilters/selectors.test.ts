...
test('getCrossFilterIndicator returns correct indicator with label from filterState.label', () => {
  const dataMask = {
...
test('getCrossFilterIndicator returns correct indicator with label from filterState.value', () => {
  const dataMask = {
...
test('getCrossFilterIndicator returns correct indicator with column and customColumnLabel', () => {
  const dataMask = {
    filterState: {
      value: 'valA',
      filters: { col: 'col' },
...
test('getCrossFilterIndicator returns correct indicator with column from extraFormData.filters', () => {
...
test('getCrossFilterIndicator returns correct indicator with column from filterState.filters', () => {
  const dataMask = {
...
test('getCrossFilterIndicator returns empty name and path if chartLayoutItem is not found', () => {
  const dataMask = {
...
test('getCrossFilterIndicator returns null value if no label or value in filterState', () => {
  const dataMask = {
    filterState: {},
    extraFormData: {},
  };
