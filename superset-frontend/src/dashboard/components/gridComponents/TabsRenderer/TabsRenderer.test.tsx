...
test('TabsRenderer renders tabs container with correct test attributes', () => {
...
test('TabsRenderer renders LineEditableTabs with correct props', () => {
  render(<TabsRenderer {...mockProps} />);
...
test('TabsRenderer applies correct tab bar padding', () => {
...
test('TabsRenderer calls handleClickTab when tab is clicked', () => {
...
test('TabsRenderer shows hover menu in edit mode', () => {
...
test('TabsRenderer hides hover menu when not in edit mode', () => {
...
test('TabsRenderer hides hover menu when renderHoverMenu is false', () => {
  const mockRef = { current: null };
...
test('TabsRenderer renders with correct tab type based on edit mode', () => {
  const { rerender } = render(<TabsRenderer {...mockProps} editMode={false} />);
...
test('TabsRenderer handles default props correctly', () => {
...
test('TabsRenderer calls onEdit when edit action is triggered', () => {
...
test('TabsRenderer renders tab content correctly', () => {
  render(<TabsRenderer {...mockProps} />);
