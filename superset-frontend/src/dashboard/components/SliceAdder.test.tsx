...
test('SliceAdder handles sort selection changes', async () => {
  renderSliceAdder();
...
test('SliceAdder handles show only my charts toggle', async () => {
  renderSliceAdder();
...
test('SliceAdder opens new chart in new tab when create new chart is clicked', () => {
...
test('SliceAdder sortByComparator should sort by changed_on in descending order', () => {
  const input = [
    {
      ...baseSlice,
      slice_id: 1,
...
test('SliceAdder sortByComparator should sort by other fields in ascending order', () => {
  const input = [
    {
      ...baseSlice,
      slice_id: 1,
...
test('SliceAdder should update selectedSliceIdsSet when props change', () => {
