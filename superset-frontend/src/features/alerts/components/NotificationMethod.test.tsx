...
test('NotificationMethod shows the right combo when ff is false', async () => {
...
test('NotificationMethod shows the textbox when the fetch fails', async () => {
  /* should show the div with "Recipients are separated by"
...
test('NotificationMethod shows the dropdown when ff is true and slackChannels succeed', async () => {
...
test('NotificationMethod shows the textarea when ff is true and slackChannels fail', async () => {
  /* should show the Select channels dropdown
    when FeatureFlag.AlertReportSlackV2 is true and fetchSlackChannels succeeds
    */
  // Mock the feature flag to be false
...
test('NotificationMethod shows the textarea when ff is true and slackChannels fail and slack is selected', async () => {
  /* should show the Select channels dropdown
    when FeatureFlag.AlertReportSlackV2 is true and fetchSlackChannels succeeds
    */
  // Mock the feature flag to be false
...
test('NotificationMethod shows the textarea when ff is true, slackChannels fail and slack is selected', async () => {
  window.featureFlags = { [FeatureFlag.AlertReportSlackV2]: true };
  jest.spyOn(SupersetClient, 'get').mockImplementation(() => {
    throw new Error('Error fetching Slack channels');
  });
...
test('NotificationMethod RefreshLabel functionality should call updateSlackOptions with force true when RefreshLabel is clicked', async () => {
