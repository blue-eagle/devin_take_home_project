...
test('UploadDataModal - General Information Elements CSV renders correctly', () => {
...
test('UploadDataModal - General Information Elements Excel renders correctly', () => {
...
test('UploadDataModal - General Information Elements Columnar renders correctly', () => {
...
test('UploadDataModal - File Settings Elements CSV file settings render correctly', async () => {
  render(<UploadDataModal {...csvProps} />, { useRedux: true });
...
test('UploadDataModal - File Settings Elements Excel file settings render correctly', async () => {
  render(<UploadDataModal {...excelProps} />, { useRedux: true });
...
test('UploadDataModal - File Settings Elements Columnar file settings render correctly', async () => {
  render(<UploadDataModal {...columnarProps} />, { useRedux: true });
...
test('UploadDataModal - Columns Elements CSV columns render correctly', async () => {
  render(<UploadDataModal {...csvProps} />, { useRedux: true });
...
test('UploadDataModal - Columns Elements Excel columns render correctly', async () => {
  render(<UploadDataModal {...excelProps} />, { useRedux: true });
...
test('UploadDataModal - Columns Elements Columnar columns render correctly', async () => {
  render(<UploadDataModal {...columnarProps} />, { useRedux: true });
...
test('UploadDataModal - Rows Elements CSV/Excel rows render correctly', async () => {
  render(<UploadDataModal {...csvProps} />, { useRedux: true });
...
test('UploadDataModal - Rows Elements Columnar does not render rows', () => {
  render(<UploadDataModal {...columnarProps} />, { useRedux: true });
...
test('UploadDataModal - Database and Schema Population database and schema are correctly populated', async () => {
  render(<UploadDataModal {...csvProps} />, { useRedux: true });
...
test('UploadDataModal - Form Validation form validation without required fields', async () => {
  render(<UploadDataModal {...csvProps} />, { useRedux: true });
...
test('UploadDataModal - Form Submission CSV form submission', async () => {
  render(<UploadDataModal {...csvProps} />, { useRedux: true });
...
test('UploadDataModal - Form Submission Excel form submission', async () => {
  render(<UploadDataModal {...excelProps} />, { useRedux: true });
...
test('UploadDataModal - Form Submission Columnar form submission', async () => {
  render(<UploadDataModal {...columnarProps} />, { useRedux: true });
...
test('File Extension Validation CSV validation returns false for invalid extensions', () => {
...
test('File Extension Validation CSV validation returns true for valid extensions', () => {
...
test('File Extension Validation Excel validation returns false for invalid extensions', () => {
  const invalidFiles = ['out', 'out.exe', 'out.xls.exe', '.csv', 'out.csv'];
  invalidFiles.forEach(fileName => {
    expect(
      validateUploadFileExtension(createTestFile(fileName), ['xls', 'xlsx']),
    ).toBe(false);
  });
});

test('File Extension Validation Excel validation returns true for valid extensions', () => {
...
test('File Extension Validation Columnar validation returns false for invalid extensions', () => {
  const invalidFiles = [
    'out',
    'out.exe',
    'out.parquet.exe',
  ...
  invalidFiles.forEach(fileName => {
    expect(
      validateUploadFileExtension(createTestFile(fileName), ['parquet', 'zip']),
    ).toBe(false);
  });
});

test('File Extension Validation Columnar validation returns true for valid extensions', () => {
  const validFiles = ['out.parquet', 'out.zip', 'out.exe.zip', 'out a.parquet'];
  validFiles.forEach(fileName => {
    expect(
      validateUploadFileExtension(createTestFile(fileName), ['parquet', 'zip']),
    ).toBe(true);
...
test('UploadDataModal Collapse Tabs renders the collaps tab CSV correctly and resets to default tab after closing', async () => {
...
test('UploadDataModal Collapse Tabs renders the collaps tab Excel correctly and resets to default tab after closing', async () => {
...
test('UploadDataModal Collapse Tabs renders the collaps tab Columnar correctly and resets to default tab after closing', async () => {
