...
test('AllEntitiesTable renders when empty with button to tag if user has perm', () => {
  render(
    <AllEntitiesTable
      search=""
...
test('AllEntitiesTable renders when empty without button to tag if user does not have perm', () => {
  render(
    <AllEntitiesTable
      search=""
      setShowTagModal={mockSetShowTagModal}
...
test('AllEntitiesTable renders the correct tags for each object type', () => {
  render(
    <AllEntitiesTable
      search=""
      setShowTagModal={mockSetShowTagModal}
...
test('AllEntitiesTable Only list asset types that have entities', () => {
  const mockObjects = {
    dashboard: [],
