...
test('RoleListAddModal renders modal with form fields', () => {
...
test('RoleListAddModal calls onHide when cancel button is clicked', () => {
  render(<RoleListAddModal {...mockProps} />);
  fireEvent.click(screen.getByTestId('modal-cancel-button'));
  expect(mockProps.onHide).toHaveBeenCalled();
});

test('RoleListAddModal disables save button when role name is empty', () => {
  render(<RoleListAddModal {...mockProps} />);
  expect(screen.getByTestId('form-modal-save-button')).toBeDisabled();
});

test('RoleListAddModal enables save button when role name is entered', () => {
  render(<RoleListAddModal {...mockProps} />);
...
test('RoleListAddModal calls createRole when save button is clicked', async () => {
  render(<RoleListAddModal {...mockProps} />);
...
test('RoleListAddModal submit handler extracts numeric IDs from permission map function', async () => {
