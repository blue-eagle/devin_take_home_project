...
test('ShareSqlLabQuery via permalink api calls storeQuery() with the query when getCopyUrl() is called', async () => {
  await act(async () => {
...
test('ShareSqlLabQuery via permalink api does not show duplicate "Copy to clipboard" tooltip on hover', async () => {
  await act(async () => {
    render(<ShareSqlLabQuery {...defaultProps} />, {
      useRedux: true,
      store,
...
test('ShareSqlLabQuery via permalink api calls storeQuery() with unsaved changes', async () => {
  await act(async () => {
    render(<ShareSqlLabQuery {...defaultProps} />, {
      useRedux: true,
      store: mockStore({
