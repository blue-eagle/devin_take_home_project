...
test('getInitialState should output the user that is passed in', () => {
  expect(getInitialState(apiData).user?.userId).toEqual(1);
});

test('getInitialState should return undefined instead of null for templateParams', () => {
  expect(
...
test('getInitialState dedupeTabHistory should dedupe the tab history', () => {
  [
    { value: [], expected: [] },
    {
      value: ['12', '3', '4', '5', '6'],
    ...
    {
      value: ['1', '2', '2', '2', '2', '2', '2', '2', '2', '2', '2', '2', '2'],
      expected: ['1', '2'],
    },
    {
      value: [
    ...
    {
      value: ['2', '2', '2', '2', '2', '2', '2', '2', '2', '2', '2', '2', '3'],
      expected: ['2', '3'],
    },
...
test('getInitialState dedupe tables schema should dedupe the table schema', () => {
...
test('getInitialState dedupe tables schema should parse the float dttm value', () => {
...
test('getInitialState restore unsaved changes for PERSISTENCE mode restore unsaved changes for PERSISTENCE mode', () => {
...
test('getInitialState restore unsaved changes for PERSISTENCE mode skip unsaved changes for expired data', () => {
  const apiDataWithLocalStorage = {
    ...apiData,
    active_tab: {
      ...apiDataWithTabState.active_tab,
...
test('getInitialState restore unsaved changes for PERSISTENCE mode skip unsaved changes for legacy cache data', () => {
  const apiDataWithLocalStorage = {
    ...apiData,
    active_tab: {
      ...apiDataWithTabState.active_tab,
